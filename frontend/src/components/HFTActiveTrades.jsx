        ...
        <table className="w-full text-xs">
          <thead className="border-b border-purple-500/20 bg-black/40">
            <tr>
              ...
              <th className="px-4 py-2 text-right font-bold text-gray-400">
                AMOUNT
              </th>
              <th className="px-4 py-2 text-right font-bold text-gray-400">
                ENTRY
              ...
              <th className="px-4 py-2 text-center font-bold text-gray-400">
                TP/SL
              </th>
              <th className="px-4 py-2 text-center font-bold text-gray-400">
                STATUS
          ...
          <tbody className="divide-y divide-purple-500/20">
            {trades.map((trade) => (
              <tr
                key={trade.id}
                className="hover:bg-purple-500/5 transition group cursor-pointer"
              >
                ...
                <td className="px-4 py-3 text-right text-purple-400 font-mono font-bold">
                ...
                <td className="px-4 py-3 text-right">
                  ...
                  <div
                    className={`text-xs ${trade.pnl >= 0 ? "text-green-400" : "text-red-400"}`}
                  >
                    {trade.pnl >= 0 ? "+" : ""}
                ...
                <td className="px-4 py-3 text-center">
                  <div className="space-y-1">
                    <div className="text-xs flex justify-center space-x-1">
                      <span
                        className={`px-2 py-0.5 rounded ${trade.tp1.sold > 0 ? "bg-green-500/30 text-green-400" : "bg-purple-500/20 text-purple-300"}`}
                      >
                        TP1: {trade.tp1.sold}%
                      </span>
                    </div>
