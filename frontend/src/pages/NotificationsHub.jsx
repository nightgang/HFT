        ...
        <div className="flex gap-2 overflow-x-auto">
          {[
            ...
            },
            {
              id: "price",
              label: "Price Alerts",
              count: notifications.filter((n) => n.type === "price").length,
            },
            {
              id: "trade",
              label: "Trade Updates",
            ...
            >
              {tab.label}
              <span className="ml-2 px-2 py-0.5 bg-slate-800/50 rounded">
                {tab.count}
              </span>
            </button>
          ))}
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      <p
                        className={`font-semibold ${notif.read ? "text-gray-300" : "text-white"}`}
                      >
                        {notif.title}
                      </p>
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="bg-slate-800 border border-purple-500/20 rounded-lg p-8 max-w-md w-full">
            ...
            <div className="flex gap-3">
              <button className="flex-1 px-4 py-2 bg-purple-600 hover:bg-purple-700 rounded-lg text-white transition-colors font-semibold">
                Action
              </button>
              <button
                onClick={() => setSelectedNotif(null)}
