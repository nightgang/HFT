...
const PnLDashboard = () => {
  ...
  const fetchPnLData = async () => {
    try {
      const response = await axios.get(`http://localhost:3001/api/pnl-dashboard?period=${period}`);
  ...
  if (!pnl) {
    return <div className="text-center py-12 text-gray-500">No P&L data available</div>;
  }
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-gradient-to-br from-blue-900/20 to-blue-900/5 border border-blue-500/30 rounded-lg p-6">
          ...
          <div className="text-3xl font-bold text-blue-400">${realizedPnL.toFixed(2)}</div>
        ...
        <div className="bg-gradient-to-br from-purple-900/20 to-purple-900/5 border border-purple-500/30 rounded-lg p-6">
          ...
          <div className="text-3xl font-bold text-purple-400">${unrealizedPnL.toFixed(2)}</div>
        ...
        <div className="bg-gradient-to-br from-yellow-900/20 to-yellow-900/5 border border-yellow-500/30 rounded-lg p-6">
          ...
          <div className="text-3xl font-bold text-yellow-400">{roi.toFixed(2)}%</div>
        ...
        <div className="space-y-4">
          <div>
            <div className="flex justify-between mb-2">
              ...
              <span className="text-white font-semibold">{pnl.winRate?.toFixed(2) || 0}%</span>
            </div>
          ...
          <div>
            <div className="flex justify-between mb-2">
              ...
              <span className="text-white font-semibold">{pnl.profitFactor?.toFixed(2) || 0}x</span>
            </div>
            <p className="text-xs text-gray-500">Gross profit / Gross loss ratio</p>
          </div>

          <div>
            <div className="flex justify-between mb-2">
              <span className="text-gray-400">Max Drawdown</span>
              <span className="text-red-400 font-semibold">{pnl.maxDrawdown?.toFixed(2) || 0}%</span>
            </div>
