module.exports = {
  ...
  theme: {
    extend: {
      ...
      keyframes: {
        'neon-glow': {
          '0%, 100%': { 'box-shadow': '0 0 10px rgba(168, 85, 247, 0.8), 0 0 20px rgba(168, 85, 247, 0.4)' },
          '50%': { 'box-shadow': '0 0 20px rgba(168, 85, 247, 1), 0 0 30px rgba(168, 85, 247, 0.6)' },
        },
        'neon-green': {
          '0%, 100%': { 'box-shadow': '0 0 10px rgba(34, 197, 94, 0.8), 0 0 20px rgba(34, 197, 94, 0.4)' },
          '50%': { 'box-shadow': '0 0 20px rgba(34, 197, 94, 1), 0 0 30px rgba(34, 197, 94, 0.6)' },
        },
        'neon-pink': {
          '0%, 100%': { 'box-shadow': '0 0 10px rgba(236, 72, 153, 0.8), 0 0 20px rgba(236, 72, 153, 0.4)' },
          '50%': { 'box-shadow': '0 0 20px rgba(236, 72, 153, 1), 0 0 30px rgba(236, 72, 153, 0.6)' },
        },
        'pulse-neon': {
          '0%, 100%': { opacity: '1' },
          '50%': { opacity: '0.7' },
